"""
Goal Tracker — ARIA's objective management.

Handles creating, updating, completing, and abandoning goals.
Goals persist across sessions and drive ARIA's sense of purpose.
"""
...
from clasp.vendor.silex.models.schemas import Goal, GoalPriority, GoalStatus
from clasp.vendor.silex.storage.database import Database
from clasp.vendor.silex.utils.logger import setup_logger

log = setup_logger("aria.goals")


class GoalTracker:
    """SQLite-backed goal lifecycle manager for ARIA."""
