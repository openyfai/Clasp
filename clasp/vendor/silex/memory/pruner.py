...
from clasp.vendor.silex.llm.base import SupportsLLM
from clasp.vendor.silex.models.schemas import Turn, ConsolidationResult
...
class ContextPruner:
    ...
    async def prune(self, turns: List[Turn], session_manager=None, memory_store=None, threshold: int = 10) -> List[Turn]:
        ...
        if memory_store:
            try:
                from clasp.vendor.silex.models.schemas import ExtractedFacts
                extraction_prompt = (
